...
export '/net_promoter_score/net_promoter_score_widget.dart'
    show NetPromoterScoreWidget;
...
export '/calorie_loss/calorie_loss_widget.dart' show CalorieLossWidget;
