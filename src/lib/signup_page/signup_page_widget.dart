...
class _SignupPageWidgetState extends State<SignupPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Signup-Page'});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: TextFormField(
                                  key: ValueKey('Signup-Email_mq81'),
                              ...
                              Container(
                                width: double.infinity,
                                child: TextFormField(
                                  key: ValueKey('Signup-Password_dqmu'),
                                  controller:
                              ...
                              Container(
                                width: double.infinity,
                                child: TextFormField(
                                  key: ValueKey('Signup-Confirm-Password_vmbj'),
                                  controller: _model
                      ...
                      FFButtonWidget(
                        key: ValueKey('Register_Button_15aj'),
                        onPressed: () async {
                          logFirebaseEvent(
                              'SIGNUP_PAGE_PAGE_Register_Button_ON_TAP');
                          logFirebaseEvent('Register_Button_validate_form');
                          ...
                          logFirebaseEvent('Register_Button_navigate_to');
                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'SIGNUP_Go_To_Login_Button_ON_TAP');
                            logFirebaseEvent('Go_To_Login_Button_navigate_to');
